#!/usr/bin/env bash
cargo run -- --bench=spark --format=csv --path=/mnt/nyctaxi/csv/year=2019 --cpus=1
cargo run -- --bench=rust --format=csv --path=/mnt/nyctaxi/csv/year=2019 --cpus=1
cargo run -- --bench=jvm --format=csv --path=/mnt/nyctaxi/csv/year=2019 --cpus=1
